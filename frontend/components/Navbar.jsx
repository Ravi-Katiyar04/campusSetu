...
//             className="text-xl md:hidden text-gray-700 dark:text-gray-300"
//           >
...
//               {profileOpen && (
//                 <div className="absolute right-0 mt-3 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg py-2 text-sm">
